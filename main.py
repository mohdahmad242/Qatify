...
# from final_qatify.qutify import Qatify
from final_qatify.model.resnet18 import resnet18
...
# quantized_model = get_qat_model(model=model)

# test_bitwidth_list = [2, 4, 8, 16]
# model_size_constraints = 4

# qatfiy = Qatify(model, quantized_model, test_bitwidth_list, model_size_constraints)
...
print("\nFloat")
evaluate(model, testloader, 'cpu')


# print("\nFused Model")
# evaluate(fused_model, testloader, 'cpu')


print("\nFake quant - PTQ")
evaluate(fake_quant_model, testloader, 'cpu')
...
print("\nConverted model")
evaluate(converted_model, testloader, 'cpu')
